/* Imported from github : Mindinventory/react-native-tabbar-interaction
*/
...
export default class TabBar extends Component{
  ...
  /* Pour contrôle de la navigation tab via props inspiré de
  * https://stackoverflow.com/questions/39041710/react-js-change-child-components-state-from-parent-component
    * */

  componentWillReceiveProps (props) {
    console.log('Tabs Props by component Will receive props:',props)
    this.update(props.tabSelected);
  }

  componentDidMount(): void {
    console.log('Tabbarmount');
    this.update(0)
  }
  ...
  render() {
    ...
    return(
      <View style={[styles.container,
        this.props.style,
        children[this.state.selectedIndex].props.screenBackgroundColor ?  children[this.state.selectedIndex].props.screenBackgroundColor : '#008080']}>
  ...
  update(index,height?,width?) {
    ...
    if(height&&width){
      ...
      console.log('TabBar UPDATE heightxwidth:'+height+'x'+width);
    }

      console.log('TabBar UPDATE index:',index);
      if(index == 0){
